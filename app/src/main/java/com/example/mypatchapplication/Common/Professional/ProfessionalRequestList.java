...
public class ProfessionalRequestList extends AppCompatActivity {
    private View decorView;
    String current_ID,current_name;
    RecyclerView historyRecycler;
    RelativeLayout progressHistory;
    final FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference allRequestRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional_request_list);
        ...
        historyRecycler = findViewById(R.id.recycler_user_requestlist);
        progressHistory = findViewById(R.id.user_requestlist_progressbar);

        progressHistory.setVisibility(View.VISIBLE);

        allRequestRef = database.getReference("HireList");
        allRequestRef.addChildEventListener(new ChildEventListener() {
            @Override
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot datas : dataSnapshot.getChildren()) {
                        ...
                        if(datas.child("professionalID").getValue().toString().equals(current_ID) && datas.child("responsestatus").getValue().toString().equals("requested")) {
                            ...
                            ProfessionalRequestRVAdapter professionalRequestRVAdapter = new ProfessionalRequestRVAdapter(hireUsModelList, ProfessionalRequestList.this);
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ProfessionalRequestList.this);
                            historyRecycler.setLayoutManager(layoutManager);
                            historyRecycler.setHasFixedSize(true);
                            historyRecycler.setAdapter(professionalRequestRVAdapter);
                        }
                    }
                }
            }
    ...
    public void requestList_goback(View view) {
        ProfessionalRequestList.super.onBackPressed();
    }
